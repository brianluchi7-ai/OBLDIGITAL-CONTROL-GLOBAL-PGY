...
# ======================================================
# === OBL DIGITAL — Generador RTN_MASTER (Reconoce estructura de Octubre) ===
# ======================================================
...
def estandarizar_columnas(df, tabla):
    ...
    rename_map = {
        ...
        "full_name": "affiliate",   # 💡 Octubre usa esta

        "monto": "usd",
        "usd": "usd",
        "usd_total": "usd",
        "amount_country": "usd",
        "ftd_day": "usd",           # 💡 Octubre usa esta
    }
    ...
    # Limpieza especial: elimina columnas totalmente vacías
...
def obtener_datos():
    ...
    tablas = [
        ...
        "dep_oct_rtn_PGY_2025",  # Octubre real
        "dep_nov_rtn_PGY_2025",
        "dep_rtn_PGY_2025"       # Diciembre
    ]
